        ...
        <div className="mt-24 flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="lg:w-1/2 space-y-6">
            <h3 className="text-4xl font-playfair font-bold text-foreground">
              Temos um <span className="gradient-primary bg-clip-text text-transparent">sistema anti-plágio</span>
            </h3>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Nossos materiais de apoio são elaborados com base em referências legítimas e estrutura técnica
              personalizada. Utilizamos sistemas de verificação de originalidade para assegurar conteúdos autênticos,
              focados em orientação e estudo acadêmico seguro.
            </p>
          </div>
